...
# - get current file:
destfile <- '/home/goransm/WMDE/Wikidata/WD_percentUsageDashboard/wdUsage_ProjectStatistics.csv'
destfileProd <- '/srv/shiny-server/WD_percentUsageDashboard/wdUsage_ProjectStatistics.csv'
URL <- 
  "https://analytics.wikimedia.org/datasets/wdUsagePercentArticle/wdUsage_ProjectStatistics.csv"
h <- new_handle()
handle_setopt(h,
...
system('sudo cp /home/goransm/WMDE/Wikidata/WD_percentUsageDashboard/wdUsage_ProjectStatistics.csv /srv/shiny-server/WD_percentUsageDashboard/wdUsage_ProjectStatistics.csv')
dataSet <- read.csv(destfileProd,
                    header = T,
                    check.names = F,
                    stringsAsFactors = F,
                    row.names = 1)
